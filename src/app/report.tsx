  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.subheading}>
        This flow captures structured request data before checking for similar open issues.
      </Text>
      ...
      <View style={styles.photoBox}>
        <Text style={styles.photoTitle}>Photo Placeholder</Text>
        <Text style={styles.photoText}>In production this would attach a camera or gallery image.</Text>
      </View>

      <Pressable style={styles.primaryButton} onPress={() => router.push('/duplicate')}>
